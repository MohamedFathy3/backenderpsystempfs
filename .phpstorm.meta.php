    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'App\Interfaces\BrandRepositoryInterface' => \App\Repositories\BrandRepository::class,
            'App\Interfaces\CategoryRepositoryInterface' => \App\Repositories\CategoryRepository::class,
            'App\Interfaces\CityRepositoryInterface' => \App\Repositories\CityRepository::class,
            'App\Interfaces\CompanyRepositoryInterface' => \App\Repositories\CompanyRepository::class,
            'App\Interfaces\CountryRepositoryInterface' => \App\Repositories\CountryRepository::class,
            'App\Interfaces\DepartmentRepositoryInterface' => \App\Repositories\DepartmentRepository::class,
            'App\Interfaces\DeviceModelRepositoryInterface' => \App\Repositories\DeviceModelRepository::class,
            'App\Interfaces\DeviceRepositoryInterface' => \App\Repositories\DeviceRepository::class,
            'App\Interfaces\DeviceStatusRepositoryInterface' => \App\Repositories\DeviceStatusRepository::class,
            'App\Interfaces\EquipmentStatusRepositoryInterface' => \App\Repositories\EquipmentStatusRepository::class,
            'App\Interfaces\GraphicCardRepositoryInterface' => \App\Repositories\GraphicCardRepository::class,
            'App\Interfaces\MemoryRepositoryInterface' => \App\Repositories\MemoryRepository::class,
            'App\Interfaces\OrganizationRepositoryInterface' => \App\Repositories\OrganizationRepository::class,
            'App\Interfaces\PermissionRepositoryInterface' => \App\Repositories\PermissionRepository::class,
            'App\Interfaces\PositionRepositoryInterface' => \App\Repositories\PositionRepository::class,
            'App\Interfaces\ProcessorRepositoryInterface' => \App\Repositories\ProcessorRepository::class,
            'App\Interfaces\ReplyRepositoryInterface' => \App\Repositories\ReplyRepository::class,
            'App\Interfaces\RoleRepositoryInterface' => \App\Repositories\RoleRepository::class,
            'App\Interfaces\StorageRepositoryInterface' => \App\Repositories\StorageRepository::class,
            'App\Interfaces\TicketRepositoryInterface' => \App\Repositories\TicketRepository::class,
            'App\Interfaces\TypeRepositoryInterface' => \App\Repositories\TypeRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.disks.avatar.driver' => 'string',
            'filesystems.disks.avatar.root' => 'string',
            'filesystems.disks.avatar.url' => 'string',
            'filesystems.disks.avatar.visibility' => 'string',
            'filesystems.links.D:\projects\pfs-ticketing-system\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.avatar.driver','filesystems.disks.avatar.root',
'filesystems.disks.avatar.url','filesystems.disks.avatar.visibility','filesystems.links.D:\\projects\\pfs-ticketing-system\\public\\storage','logging.default','logging.deprecations.channel',
...
'broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','concurrency.default','hashing.driver',
...
'excel.temporary_files.force_resync_remote','tinker.commands','tinker.alias','tinker.dont_alias','ide-helper.filename',
...
'ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits',);
...
'sanctum.csrf-cookie','user.index','user.store','user.show','user.update',
'user.destroy','company.index','company.store','company.show',
'company.update','company.destroy','department.index','department.store',
'department.show','department.update','department.destroy','role.index',
'role.store','role.show','role.update','role.destroy',
'permission.index','permission.store','permission.show','permission.update','permission.destroy','brand.index',
'brand.store','brand.show','brand.update','brand.destroy',
'memory.index','memory.store','memory.show','memory.update','memory.destroy','storage.index','storage.store','storage.show','storage.update',
'storage.destroy','processor.index','processor.store','processor.show',
'processor.update','processor.destroy','device-model.index','device-model.store',
'device-model.show','device-model.update','device-model.destroy','graphic-card.index','graphic-card.store',
'graphic-card.show','graphic-card.update','graphic-card.destroy',
'category.index','category.store','category.show','category.update','category.destroy',
'device.index','device.store','device.show','device.update','device.destroy',
'ticket.index','ticket.store','ticket.show','ticket.update','ticket.destroy','type.index',
'type.store','type.show','type.update','type.destroy','equipment-status.index',
'equipment-status.store','equipment-status.show','equipment-status.update','equipment-status.destroy',
'position.index','position.store','position.show','position.update','position.destroy','device-status.index','device-status.store','device-status.show','device-status.update',
'device-status.destroy','organization.index','organization.store',
'organization.show','organization.update','organization.destroy','country.index','country.store',
'country.show','country.update','country.destroy','city.index',
'city.store','city.show','city.update','city.destroy','branch.index','branch.store','branch.show','branch.update',
'branch.destroy','storage.local',);
        registerArgumentsSet('views', 
'emails.helpDeskTicket','exports.device_history','exports.tickets_report','pdf.device_acknowledgement','laravel-exceptions-renderer::components.card',
